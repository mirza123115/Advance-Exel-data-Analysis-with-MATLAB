...
workbook='D:\3stack\TILT_analysis_allcorner_noFB_exp2_nbias600mV_exp2.xlsx';
...
for j=1:12;
[VT_adder,dlt,dlc] = importfile(workbook,j,3,114);
VT_y(:,j)=VT_adder;
dlt_y(:,j)=dlt;
dlc_y(:,j)=dlc;
...
xlswrite(workbook,vt,13,'C12:N19')

%difference between manual and automation
xlswrite(workbook,vt-xlsread(workbook,13,'C2:N9'),13,'C22:N29')
